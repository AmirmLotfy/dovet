...
export default defineConfig({
  ...
  projects: [
    { name: "desktop", testIgnore: /record-demo\.spec\.ts/, use: { ...devices["Desktop Chrome"], channel: "chrome", viewport: { width: 1440, height: 1000 } } },
    { name: "mobile", testIgnore: /record-demo\.spec\.ts/, use: { ...devices["Pixel 7"], channel: "chrome", viewport: { width: 390, height: 844 } } },
